...
external_url 'http://gitlab.int.xcalar.com' # default: http://hostname
...
gitlab_rails['omniauth_providers'] = [
  {
    "name" => "google_oauth2",
    "app_id" => "309583985413-49uust32qe7simiosejrdm1mj69jne14.apps.googleusercontent.com",
    "app_secret" => "J7PqNy0Kq8EvMmJwyFew4HuA",
